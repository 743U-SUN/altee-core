    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl font-bold">ようこそ</CardTitle>
          <CardDescription>
            アカウントにサインインしてください
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <form action={handleDiscordSignIn}>
            <Button 
              ...
              className="w-full h-12 text-left justify-start gap-3"
            >
              <svg className="w-5 h-5 text-[#5865f2]" viewBox="0 0 24 24">
          ...
          <div className="text-center text-sm text-gray-600">
            <Link href="/demo/auth-test" className="text-blue-600 hover:underline">
              認証テストページ
            </Link>
            で詳細な機能を確認できます
          </div>
