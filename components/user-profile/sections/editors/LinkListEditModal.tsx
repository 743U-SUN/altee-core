...
import type { LinkListData } from '@/types/profile-sections'
import { nanoid } from 'nanoid'

interface LinkListEditModalProps {
  isOpen: boolean
  onClose: () => void
  sectionId: string
  currentData: LinkListData
}
...
export function LinkListEditModal({
  isOpen,
  onClose,
  sectionId,
  currentData,
}: LinkListEditModalProps) {
  ...
  const [editingBackup, setEditingBackup] = useState<EditingLink | null>(null)
  ...
  const handleFieldChange = (linkId: string, field: 'title' | 'url' | 'description', value: string) => {
    setLinks((prev) =>
                ...
                <div className="pt-3 mt-3 border-t space-y-3">
                  <div>
                    ...
                    <Input
                      ...
                      placeholder="例: Portfolio Website"
                      autoFocus
                    />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      placeholder="例: Check out my full works here"
                      rows={2}
