...
import type { ImageGrid3Data } from '@/types/profile-sections'

interface ImageGrid3EditModalProps {
  isOpen: boolean
  onClose: () => void
  sectionId: string
  currentData: ImageGrid3Data
}

const ITEM_COUNT = 3

export function ImageGrid3EditModal({
  isOpen,
  onClose,
  sectionId,
  currentData,
}: ImageGrid3EditModalProps) {
  const {
    sortedItems,
    isPending,
    updateItem,
  ...
  return (
    <EditModal isOpen={isOpen} onClose={onClose} title="画像グリッド (3列) を編集" hideActions>
